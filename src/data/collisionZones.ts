...
import {
  THEATER_DOOR_LEFT,
  THEATER_DOOR_LINTEL_BOTTOM_Y,
  THEATER_DOOR_RIGHT,
} from './theaterEntrance'
...
export const COLLISION_ZONES: Record<string, CollisionZone[]> = {
  five: [
    // North storefront band, split for gym + Sunset Bakery theater doors.
    { x: 12, y: 265, width: OCEANVIEW_GYM_DOOR_LEFT - 12, height: 62 },
    { x: OCEANVIEW_GYM_DOOR_RIGHT, y: 265, width: THEATER_DOOR_LEFT - OCEANVIEW_GYM_DOOR_RIGHT, height: 62 },
    {
      x: THEATER_DOOR_RIGHT,
      y: 265,
      width: 1254 - THEATER_DOOR_RIGHT,
      height: 62,
    },
    // Lintel above Oceanview Gym door.
    {
    ...
    // Lintel above Sunset Bakery / theater door.
    {
      x: THEATER_DOOR_LEFT,
      y: 265,
      width: THEATER_DOOR_RIGHT - THEATER_DOOR_LEFT,
      height: THEATER_DOOR_LINTEL_BOTTOM_Y - 265,
    },
    ...
    // Facade trim west of theater door (door gap x 968–1028 stays walkable).
    { x: 946, y: 350, width: THEATER_DOOR_LEFT - 946, height: 40 },
    ...
    // Sidewalk band east of gym door (ends before Sunset Bakery block).
    { x: OCEANVIEW_GYM_DOOR_RIGHT, y: 433, width: 842 - OCEANVIEW_GYM_DOOR_RIGHT, height: 60 },
    { x: 956, y: 442, width: THEATER_DOOR_LEFT - 956, height: 41 },
    { x: THEATER_DOOR_RIGHT, y: 442, width: 1074 - THEATER_DOOR_RIGHT, height: 41 },
