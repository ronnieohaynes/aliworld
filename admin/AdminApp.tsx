...
import { hasAnalyticsClientConfig } from './analyticsApi'
...
export function AdminApp() {
  ...
  const handleUnlock = useCallback(
    (e: React.FormEvent) => {
      e.preventDefault()
      const expected = __ANALYTICS_ADMIN_SECRET__
      if (!expected) {
        setError('Set VITE_ANALYTICS_ADMIN_SECRET in .env.local')
        return
      }
...
VITE_ANALYTICS_ADMIN_SECRET=your-shared-admin-secret`}
        </pre>
        <p>
